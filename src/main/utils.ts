...
/**
 * Local-calendar date key (`YYYY-MM-DD`) in the machine's timezone, for
 * day-boundary comparisons and dated filenames. Throws on invalid dates so
 * bad data fails loudly instead of keying under "NaN-NaN-NaN".
 */
